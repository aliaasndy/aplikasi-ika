...
st.header("± Pengaturan Deviasi")

st.info(
    "Nilai deviasi telah dimasukkan berdasarkan pembahasan sebelumnya. "
    "Arah + atau - ditampilkan secara terpisah agar penerapannya "
    "tidak tertukar pada perhitungan."
)

arah_col1, arah_col2 = st.columns(2)

with arah_col1:

    arah_ph = st.selectbox(
        "Arah deviasi pH",
        ["+", "-"],
        key="arah_ph"
    )

    arah_bod = st.selectbox(
        "Arah deviasi BOD",
        ["+", "-"],
        key="arah_bod"
    )

    arah_cod = st.selectbox(
        "Arah deviasi COD",
        ["+", "-"],
        key="arah_cod"
    )

    arah_tss = st.selectbox(
        "Arah deviasi TSS",
        ["+", "-"],
        key="arah_tss"
    )
...
with arah_col2:
    ...
    arah_do = st.selectbox(
        "Arah deviasi DO",
        ["+", "-"],
        key="arah_do"
    )

    arah_no3 = st.selectbox(
        "Arah deviasi NO3-N",
        ["+", "-"],
        key="arah_no3"
    )

    arah_tp = st.selectbox(
        "Arah deviasi T-P",
        ["+", "-"],
        key="arah_tp"
    )

    arah_fecal = st.selectbox(
        "Arah deviasi Fecal Coli",
        ["+", "-"],
        key="arah_fecal"
    )
